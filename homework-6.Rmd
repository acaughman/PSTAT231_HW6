...
```{r}
rf_test_fit = fit(rf_final, poke_test) #fit poke testing data to best model: the random forest model
```
...
```{r}
rf_test_fit = augment(rf_test_fit, new_data = poke_test) #get predictions for test data
...
**Answer:** The model predicted normal, bug, fire, and grass Pokemon the best. It did not do a good job at predicting psychic or water pokemon
